...
exec "$PYTHON_BIN" -m experiments.syllogimous_bitter_lesson.train_rl \
  ...
  --logic-modulus 4 --learning-signal verifier \
  ...
  --checkpoint experiments/syllogimous_bitter_lesson/cyclic_mod4_learnability.pt \
  --report experiments/syllogimous_bitter_lesson/cyclic_mod4_learnability.json
