...
def main() -> None:
    ...
    parent_curve = _curve(
        parent, count=args.count, seed=args.seed, device=device)
    child_curve = _curve(
        child, count=args.count, seed=args.seed, device=device)
    gains = {
        key: (
    ...
    gates = {
        ...
        "next_rung_gain_at_least_1_5_points": gains[next_key] >= 0.015,
    }
    report = {
        ...
        "configuration": {
            ...
            "blends": BLENDS, "device": str(device)},
