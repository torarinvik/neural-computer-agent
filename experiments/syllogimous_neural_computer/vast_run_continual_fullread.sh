...
$PY -m experiments.syllogimous_neural_computer.train_continual \
  ...
  --learning-rate 1e-4 --threshold 0.001 --read-top-k 64 --write-cost 0.0 \
  --initial-checkpoint experiments/syllogimous_neural_computer/vast_hard_memory.pt \
  --checkpoint experiments/syllogimous_neural_computer/vast_continual_fullread.pt \
  --report experiments/syllogimous_neural_computer/vast_continual_fullread.json
