...
OUT=experiments/syllogimous_neural_computer/targeted_rehearsal_groups
mkdir -p "$OUT"
for groups in 1 2 3 6; do
...
"$PYTHON" -m experiments.syllogimous_neural_computer.summarize_rehearsal \
