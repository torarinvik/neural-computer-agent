"""Pilot one external capability on verifier-private generated programs."""
...
def run(args: argparse.Namespace) -> dict[str, object]:
    ...
    program, decoder = _new_capability(args.seed + 1)
    ...
    report = {
        "schema": "neural-computer.generated-composition-capability-report.v1",
        "claim_boundary": (
            "One frozen-core external recurrent capability learned a sampled "
            "two-primitive composition workload from rendered events and "
            "scalar outcomes. This is an acquisition diagnostic, not a "
            "continual-learning or open-ended program-induction claim."
        ),
        "seed": args.seed,
