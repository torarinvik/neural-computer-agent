...
all candidates are exhausted without evidence.
...
def run(args: argparse.Namespace) -> dict[str, object]:
    ...
    gates = {
        ...
        "files_unchanged_during_calibration": training_digests == calibration_digests,
    ...
    report = {
        ...
        "accounting": {
            ...
            "unique_verifier_bits": training_bits + calibration_bits + retention_bits,
