...
final_arms = {winner: encode_with(candidates[winner]),
              "vocab_peaks": encode_with(candidates["vocab_peaks"]),
              "vocab_greedy_margin": encode_with(
                  candidates["vocab_greedy_margin"]),
