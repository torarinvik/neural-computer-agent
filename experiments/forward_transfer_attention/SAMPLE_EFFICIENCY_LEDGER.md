...
|---|---|---:|---:|---|
| 2026-08-01 | Brain Workshop-style dual-stream gym plumbing | Deterministic 24-trial n-back episode; oracle 100% and 1.05 fast-reward score; two independent amodal events | Random/no-op 25%, inverted 0%; target-private and replay-deterministic | Valid visual+audio+keypress gym surface; no learned-agent or compounding claim until a fresh-vs-experienced training curve exists |
| 2026-08-01 | Tiny vision n-back-1 learning probe | Fresh reward-only and frozen-controller adapter runs on stochastic two-choice n-back; live gradients; 256–2,048 unique lifetimes | Fresh held-out 57.50% before/after, history-reset 56.45%, time-shuffle 56.03%; frozen adapter fell 43.80%→40.92%; disposable supervised ceilings tracked time-shuffle | Plumbing works, but no causal temporal-learning gate passed; do not scale reward budget before a label-free representation/value-baseline rung |
| 2026-08-01 | Reward-only visual n-back breakthrough | Self-supervised RGB reconstruction encoder (decoder discarded) + generic one-step RAM + zero-init event×retrieved-memory adapter; 128 updates × 64 unique lifetimes | Seeds 44011/44012: 100% held-out; history reset 56.53/56.57%; temporal shuffle 57.17/57.98%; corrected oracle shuffle audit passed | First causal scalar-reward temporal memory result; promote the mechanism to 4-position, 8-position, audio, and dual-stream ladders before claiming generality |
| 2026-08-01 | Four-position reward-only promotion | Fresh self-supervised four-position encoder + same frozen encoder/RAM/controller mechanism; 256 updates × 64 lifetimes after a rejected 128-update rung | Seeds 44021/44022: 92.74%/80.87% held-out; history reset 56.54%/56.52%; temporal shuffle 58.06%/56.63% | Second causal promotion; the ignition threshold grows with difficulty, so continue gradual ladder rather than jumping to eight-way or dual-stream |
| 2026-08-01 | Eight-position reward-only promotion | Fresh self-supervised eight-position encoder + same generic RAM/retrieved-memory adapter; 256 updates × 64 lifetimes | Seeds 44031/44032: 66.09%/70.85% held-out; history reset 56.58%/56.54%; temporal shuffle 57.10%/57.51% | Visual 1-back ladder complete across 2/4/8 locations; audio and dual-stream composition remain untested |
