...
OUT=experiments/forward_transfer_attention/targeted_replication
mkdir -p "$OUT"
pids=()
for seed in 11 23 37 51; do
  OMP_NUM_THREADS=32 MKL_NUM_THREADS=32 /venv/main/bin/python \
    ...
    --epochs 12 --primitive-epochs 3 --read-top-k 1 --query-count 4 \
    --learning-rate 0.0001 --advantage-weight 0.5 --advantage-margin 0.5 \
