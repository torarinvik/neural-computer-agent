...
def seed_everything(seed: int) -> None:
    ...
    # Research decisions depend on exact-parent replication.  Benchmark-mode
    # kernel selection and nondeterministic CUDA algorithms can otherwise move
    # a horse across a causal gate despite identical declared seeds.
