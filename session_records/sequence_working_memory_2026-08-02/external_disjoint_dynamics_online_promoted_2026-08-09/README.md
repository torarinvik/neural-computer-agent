...
This two-seed rung removes the nested `position + delta` structure used by
...
| metric | seed 70411 | seed 70412 |
| --- | ---: | ---: |
| target-C warm/fresh updates | 36 / 44 | 35 / 40 |
| target-D warm/fresh updates | 32 / 43 | 31 / 35 |
| all-regime planner mastery | 1.0 | 1.0 |
| source-slot mastery after all phases | 1.0 | 1.0 |
| target-C/D admission count | 1 / 1 | 1 / 1 |
| target-C/D reuse count | 1 / 1 | 1 / 1 |
| old-slot optimizer updates | 0 | 0 |

Every gate passed: both novel regimes were admitted without labels, later
