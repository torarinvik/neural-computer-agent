...
stream B. Clean observations from both streams then reverse back to their
original opaque slots. A fresh gate-disabled control matches the same
corruption, establishing that the veto is causal.
