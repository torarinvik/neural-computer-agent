# Eight-capability verifier-gated adapter-sharing growth — promoted

Date: 2026-08-08

The frozen-controller protocol acquires eight opaque capabilities without
...
prefix, and local recovery remains available for a newly grown capability.

| seed | final behavior | physical compute | physical adapters | promoted |
| --- | --- | ---: | ---: | --- |
| 69316 | `1.000 / 0.895 / 1.000 / 0.797 / 0.766 / 0.813 / 0.789 / 0.906` | 8 | 2 | yes |
| 69317 | `1.000 / 0.750 / 0.867 / 0.855 / 0.770 / 0.832 / 0.879 / 0.859` | 7 | 2 | yes |
...
reduced payload, and zero-replay gates. This is a bounded eight-capability
