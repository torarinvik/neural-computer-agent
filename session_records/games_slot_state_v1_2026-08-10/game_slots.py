...
def roll(verifier: FamilyVerifier, count: int, generator) -> dict:
    states, acts, nxt, outcomes = [], [], [], []
    while len(states) * verifier.batch_size < count:
