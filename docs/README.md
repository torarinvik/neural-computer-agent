...
- `FAST_ITERATION.md`: experiment sizing and escalation discipline.

Historical narrative documents were removed from the working tree. Git history
remains the archive; current claims must point to curated records under
`session_records/`.
